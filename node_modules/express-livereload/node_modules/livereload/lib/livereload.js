...
(function() {
  ...
  Server = (function() {
    function Server(config) {
      var _base, _base1, _base2, _base3, _base4, _base5, _base6, _base7, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      if ((_ref5 = (_base4 = this.config).alias) == null) {
        _base4.alias = {};
      }
      if ((_ref6 = (_base5 = this.config).delay) == null) {
        _base5.delay = 0;
      }
      ...
      if ((_ref7 = (_base6 = this.config).applyJSLive) == null) {
        _base6.applyJSLive = false;
      }
      if ((_ref8 = (_base7 = this.config).applyCSSLive) == null) {
